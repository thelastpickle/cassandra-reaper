...
public final class Migration002 {

    private static final Logger LOG = LoggerFactory.getLogger(Migration002.class);
            ...
            for(Row row : session.execute(QueryBuilder.select().from("repair_unit"))) {
                ...
                session.execute(
                        insertRprUnit.bind(
                                ...
                                row.getString("incremental_repair")));
            }
