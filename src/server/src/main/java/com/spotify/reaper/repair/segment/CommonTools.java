...
public final class CommonTools {
   ...
   *
   * @throws com.spotify.reaper.repair.ReaperException if repair run fails to be stored into Reaper's
   * storage.
   */
 ...
 * @param incrementalRepair
  ...
  private static List<RepairSegment.Builder> createRepairSegments(List<RingRange> tokenSegments, RepairUnit repairUnit){
    ...
    tokenSegments.forEach(RingRange range -> repairSegmentBuilders.add(new RepairSegment.Builder(range, repairUnit.getId())));
  ...
  private static List<RepairSegment.Builder> createRepairSegmentsForIncrementalRepair(
    ...
    nodes.entrySet().forEach(Entry<String, RingRange> range
