...
public final class JmxStreamsProxy implements StreamsProxy {

  private static final Logger LOG = LoggerFactory.getLogger(JmxStreamsProxy.class);

  private final JmxCassandraManagementProxy proxy;

  JmxStreamsProxy(JmxCassandraManagementProxy proxy) {
    this.proxy = proxy;
  }
