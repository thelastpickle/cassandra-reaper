...
public class ConcurrencyDao {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(ConcurrencyDao.class);
  ...
  public ConcurrencyDao(VersionNumber version, UUID reaperInstanceId, Session session) {
