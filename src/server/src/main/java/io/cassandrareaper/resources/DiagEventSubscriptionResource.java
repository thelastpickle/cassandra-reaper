...
public class DiagEventSubscriptionResource {
  ...
  public Response addEventSubscription(
    ...
    subscription = context.diagEventService.addEventSubscription(subscription);
  ...
  public Response getEventSubscription(
    ...
    Optional<DiagEventSubscription> subscription = context.diagEventService.getEventSubscription(id);
    if (!subscription.isPresent()) {
      return Response.status(Response.Status.NOT_FOUND).build();
    }
    return Response.ok().entity(subscription.get()).build();
  }
  ...
  public Response deleteEventSubscription(
    ...
    assert id.equals(subscription.get().getId());
    if (context.diagEventService.deleteEventSubscription(id)) {
      return Response.ok().entity(subscription.get()).build();
    } else {
