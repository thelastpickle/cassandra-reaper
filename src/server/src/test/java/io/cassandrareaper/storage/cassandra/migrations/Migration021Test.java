...
public final class Migration021Test {
  ...
  @Test
  public void testMigrateWithCassandra3_0_8_ShouldAlterTables() {
    ...
    // Execute
    Migration021.migrate(mockSession, keyspaceName);

    // Verify - Both tables should be altered
    verify(mockSession, times(2)).execute(anyString());
  }

  @Test
  public void testMigrateWithCassandra3_8_ShouldAlterTables() {
  ...
  @Test
  public void testMigrateWithCassandra4_0_ShouldAlterTables() {
  ...
  @Test
  public void testMigrateWithCassandra2_2_ShouldNotAlterTables() {
  ...
  @Test
  public void testMigrateWithCassandra3_0_7_ShouldNotAlterTables() {
  ...
  @Test
  public void testMigrateWithCassandra3_1_ShouldNotAlterTables() {
  ...
  @Test
  public void testMigrateWhenAlreadyUsingTwcs_ShouldNotAlterTables() {
    ...
    // Verify - No tables should be altered since already using TWCS
    verify(mockSession, never()).execute(anyString());
  }
  ...
  public void testMigrateWithRuntimeException_ShouldCatchAndContinue() {
    ...
    when(mockKeyspace.getTable("node_metrics_v1")).thenReturn(Optional.of(mockTable));
