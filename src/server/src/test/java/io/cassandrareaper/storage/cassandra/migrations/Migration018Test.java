...
public final class Migration018Test {
  ...
  public void testMigrateCallsFixRepairRunTimestamps() {
    ...
    // Execute
    Migration018.migrate(mockSession);
  ...
  public void testMigrateWithDataCallsFixRepairRunTimestamps() {
    ...
    when(mockRow.getString("state")).thenReturn("NOT_STARTED");
    when(mockRow.getInstant("start_time")).thenReturn(invalidStartTime); // Invalid for NOT_STARTED
