...
public final class CassandraManagementProxyTest {
  ...
  public static JmxCassandraManagementProxy mockJmxProxyImpl()
      throws UnknownHostException, ReaperException {
  ...
  public void testVersionCompare() throws ReaperException {
    ...
    assertEquals(
        Integer.valueOf(0), ICassandraManagementProxy.versionCompare("1000.999", "1000.999"));
    ...
    assertEquals(
        Integer.valueOf(-1), ICassandraManagementProxy.versionCompare("99.0.10~1", "99.0.10~2"));
