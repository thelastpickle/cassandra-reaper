...
@CucumberOptions(features = "classpath:io.cassandrareaper.acceptance/access_control.feature")
public final class ReaperAuthIT {

  private static final Logger LOG = LoggerFactory.getLogger(ReaperAuthIT.class);
  private static ReaperJettyTestSupport runnerInstance;
  private static final String MEMORY_CONFIG_FILE =
      "cassandra-reaper-at-access-control-enabled.yaml";

  private ReaperAuthIT() {}
