...
public class StreamServiceTest {
	...
	public void testListStreams()
		...
		List<StreamSession> result = StreamService.create(() -> clusterFacadeSpy)
	...
	public void testGetStreams_3_11_2()
		...
		// compare the test payload with an actual payload grabbed from a 2.1.20 ccm
		// node
	...
	private CompositeType streamStateType_4_0_0() throws OpenDataException {
		...
		String[] itemNames = { "currentRxBytes", "currentTxBytes", "description", "planId", "rxPercentage", "sessions",
				"totalRxBytes", "totalTxBytes", "txPercentage" };
		String[] itemDescriptions = { "currentRxBytes", "currentTxBytes", "description", "planId", "rxPercentage",
				"sessions", "totalRxBytes", "totalTxBytes", "txPercentage" };
		OpenType[] itemTypes = { SimpleType.LONG, SimpleType.LONG, SimpleType.STRING, SimpleType.STRING,
				SimpleType.DOUBLE, ArrayType.getArrayType(makeSessionsType4_0()), SimpleType.LONG, SimpleType.LONG,
				SimpleType.DOUBLE };
	...
	private CompositeType streamStateType_2_1_20() throws OpenDataException {
		...
		OpenType[] itemTypes = { SimpleType.LONG, SimpleType.LONG, SimpleType.STRING, SimpleType.STRING,
				SimpleType.DOUBLE, ArrayType.getArrayType(makeSessionsTypePost2_1()), SimpleType.LONG, SimpleType.LONG,
				SimpleType.DOUBLE };
	...
	private CompositeType streamStateType_2_0_17() throws OpenDataException {
		...
		String[] itemDescriptions = { "currentRxBytes", "currentTxBytes", "description", "planId", "rxPercentage",
				"sessions", "totalRxBytes", "totalTxBytes", "txPercentage" };
		OpenType[] itemTypes = { SimpleType.LONG, SimpleType.LONG, SimpleType.STRING, SimpleType.STRING,
				SimpleType.DOUBLE, ArrayType.getArrayType(makeSessionsTypePre2_1()), SimpleType.LONG, SimpleType.LONG,
				SimpleType.DOUBLE };
	...
	private CompositeDataSupport makeSessions_4_0_0() throws OpenDataException {
		...
		CompositeDataSupport[] receivingFiles = { new CompositeDataSupport(makeFilesType_4_0_0(), receivingFile) };
	...
	private CompositeDataSupport makeSessions_3_11_2() throws OpenDataException {
		...
		secondSendingFile.put("fileName",
		...
		CompositeDataSupport[] sendingFiles = { new CompositeDataSupport(makeFilesType_2_1_20(), firstSendingFile),
	...
	private CompositeDataSupport makeSessions_2_2_12() throws OpenDataException {
		...
		sendingFilesFields.put("fileName",
		...
		CompositeDataSupport[] sendingFiles = { new CompositeDataSupport(makeFilesType_2_1_20(), sendingFilesFields) };
	...
	private CompositeDataSupport makeSessions_2_1_20() throws OpenDataException {
		...
		receivingFilesFields.put("fileName",
	...
	private CompositeType makeSessionsType4_0() throws OpenDataException {
		...
		String[] itemNames = { "connecting", "connecting_port", "peer", "peer_port", "planId", "receivingFiles",
				"receivingSummaries", "sendingFiles", "sendingSummaries", "sessionIndex", "state" };
		String[] itemDescriptions = { "connecting", "connecting_port", "peer", "peer_port", "planId", "receivingFiles",
				"receivingSummaries", "sendingFiles", "sendingSummaries", "sessionIndex", "state" };
		OpenType[] itemTypes = { SimpleType.STRING, SimpleType.INTEGER, SimpleType.STRING, SimpleType.INTEGER,
				SimpleType.STRING, ArrayType.getArrayType(makeFilesType_4_0_0()),
				ArrayType.getArrayType(makeSummariesType_4_0_0()), ArrayType.getArrayType(makeFilesType_4_0_0()),
				ArrayType.getArrayType(makeSummariesType_4_0_0()), SimpleType.INTEGER, SimpleType.STRING, };
	...
	private CompositeType makeSessionsTypePost2_1() throws OpenDataException {
		String typeName = "org.apache.cassandra.streaming.SessionInfo";
		String description = "SessionInfo";
		String[] itemNames = { "connecting", "peer", "planId", "receivingFiles", "receivingSummaries", "sendingFiles",
				"sendingSummaries", "sessionIndex", "state" };
		String[] itemDescriptions = { "connecting", "peer", "planId", "receivingFiles", "receivingSummaries",
				"sendingFiles", "sendingSummaries", "sessionIndex", "state" };
	...
	private CompositeType makeSessionsTypePre2_1() throws OpenDataException {
		...
		String[] itemDescriptions = { "connecting", "peer", "planId", "receivingFiles", "receivingSummaries",
				"sendingFiles", "sendingSummaries", "state" };
		OpenType[] itemTypes = { SimpleType.STRING, SimpleType.STRING, SimpleType.STRING,
				ArrayType.getArrayType(makeFilesType_2_0_17()), ArrayType.getArrayType(makeSummariesType_pre_4_0()),
				ArrayType.getArrayType(makeFilesType_2_0_17()), ArrayType.getArrayType(makeSummariesType_pre_4_0()),
				SimpleType.STRING, };
	...
	private CompositeType makeFilesType_4_0_0() throws OpenDataException {
		...
		String[] itemNames = { "currentBytes", "direction", "fileName", "peer", "peer storage port", "planId",
				"sessionIndex", "totalBytes" };
		String[] itemDescriptions = { "currentBytes", "direction", "fileName", "peer", "peer storage port", "planId",
				"sessionIndex", "totalBytes" };
		OpenType[] itemTypes = { SimpleType.LONG, SimpleType.STRING, SimpleType.STRING, SimpleType.STRING,
				SimpleType.INTEGER, SimpleType.STRING, SimpleType.INTEGER, SimpleType.LONG, };
	...
	private CompositeType makeFilesType_2_1_20() throws OpenDataException {
		String typeName = "org.apache.cassandra.streaming.ProgressInfo";
		String description = "ProgressInfo";
		String[] itemNames = { "currentBytes", "direction", "fileName", "peer", "planId", "sessionIndex",
				"totalBytes" };
		String[] itemDescriptions = { "currentBytes", "direction", "fileName", "peer", "planId", "sessionIndex",
				"totalBytes" };
		OpenType[] itemTypes = { SimpleType.LONG, SimpleType.STRING, SimpleType.STRING, SimpleType.STRING,
				SimpleType.STRING, SimpleType.INTEGER, SimpleType.LONG, };
	...
	private CompositeType makeFilesType_2_0_17() throws OpenDataException {
		String typeName = "org.apache.cassandra.streaming.ProgressInfo";
		String description = "ProgressInfo";
		String[] itemNames = { "currentBytes", "direction", "fileName", "peer", "planId", "totalBytes" };
		String[] itemDescriptions = { "currentBytes", "direction", "fileName", "peer", "planId", "totalBytes" };
		OpenType[] itemTypes = { SimpleType.LONG, SimpleType.STRING, SimpleType.STRING, SimpleType.STRING,
	...
	private CompositeType makeSummariesType_4_0_0() throws OpenDataException {
		...
		String[] itemNames = { "tableId", "files", "totalSize" };
		String[] itemDescriptions = { "tableId", "files", "totalSize" };
		OpenType[] itemTypes = { SimpleType.STRING, SimpleType.INTEGER, SimpleType.LONG };
	...
	private CompositeType makeSummariesType_pre_4_0() throws OpenDataException {
		String typeName = "org.apache.cassandra.streaming.StreamSummary";
		String description = "StreamSummary";
		String[] itemNames = { "cfId", "files", "totalSize" };
		String[] itemDescriptions = { "cfId", "files", "totalSize" };
		OpenType[] itemTypes = { SimpleType.STRING, SimpleType.INTEGER, SimpleType.LONG };
